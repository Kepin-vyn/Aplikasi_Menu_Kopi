...
| :---: | :---: |
| ![Login Portrait](screenshot/login_portrait.png) | ![Login Landscape](screenshot/login_landscape.png) |
...
| :---: | :---: | :---: |
| ![Search](screenshot/search_feature.png) | ![Sort A-Z](screenshot/sort_az.png) | ![Sort Z-A](screenshot/sort_za.png) |

### 4. Monitoring Logcat (Tag: 42430055)
![Logcat Screenshot](screenshot/logcat_nim.png)
